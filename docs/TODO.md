...
| P1 | Generation integration gaps | Populate shrine/curse rooms, guarantee requested landmarks, and validate enough reachable keys for locks. Boss-template selection is fixed. | Generator-to-GameManager metadata contract. |

...
The July 2026 stabilization checkpoint advances saves to version 16, persists behavior-critical relic hook state and scheduler order zero, hardens meta/daily persistence, routes more damage sources through relic hooks, improves deterministic generation and AI behavior, and adds attack/death/heal/pickup feedback. Known follow-ups, including functional special-room population, boss-template selection, skipped-turn status output, and authored enemy sprite-path rendering, remain tracked in `docs/IMPROVEMENT_SUGGESTIONS.md`.
